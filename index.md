...
<div style="text-align: center; margin-top: 60px;">
  ...
  <div style="background:#2c2f33; padding:20px; border-radius:12px; color:#ddd; max-width: 500px; margin: 30px auto;">
    This website is powered by <strong>GitHub Pages + Jekyll</strong>. You can build your site for free in under <strong>5 minutes</strong>.
  </div>
...
<div style="max-width: 600px; margin: 40px auto; background: #202226; padding: 30px; border-radius: 12px; color: #ccc;">
  ...
  <p><strong>Kampus:</strong> Politeknik Negeri Los Males</p>
  <p><strong>Minat:</strong> Web Development, GitHub Pages, dan Jekyll</p>

  <p style="margin-top: 20px;">
    <a href="https://github.com/cutyumnaassyifa22" style="color:#28a745;">GitHub</a> •
    <a href="cutyumna139@gmail.com" style="color:#28a745;">Email</a>
  </p>
</div>
